...
<body>
	...
	<div id="wrapper">
		...
		<div id="content">
			...
			<form action="companyLogin" method="post" onsubmit="return loginCheck()">
				<!-- 아이디 -->
				<div>
					<h3 class="join_title">
						<label for="id">업체 아이디</label>
					</h3>
				...
				<div>
					<h3 class="join_title">
						<label for="pw">업체 비밀번호</label>
					</h3>
					<span class="box int_pass"> 
					<input type="password" name="cpw" id="cpw" class="int" maxlength="20" autocomplete="off">
					</span> 
